(function (scope) {
  ...
  var _JsArray_initialize = F3(
    function (size, offset, func) {
  ...
  var _JsArray_indexedMap = F3(
    function (func, offset, array) {
      var length = array.length;
      var result = new Array(length);
    ...
    if (typeof value === 'object' && '$' in value) {
      ...
      if (tag === '::' || tag === '[]') {
        ...
        for (
          ...
          output +=
            ',' + _Debug_toAnsiString(ansi, value.a);
        }
        return output + ']';
      }
  ...
  function _Utils_eqHelp(x, y, depth, stack) {
    ...
    for (var key in x) {
      if (
        !_Utils_eqHelp(x[key], y[key], depth + 1, stack)
      ) {
        return false;
      }
    }
  ...
  var _String_map = F2(function (func, string) {
    ...
    while (i < len) {
      ...
      if (0xd800 <= word && word <= 0xdbff) {
        array[i] = func(
          _Utils_chr(string[i] + string[i + 1]),
        );
        i += 2;
        continue;
      }
  ...
  var _Json_decodeFloat = _Json_decodePrim(
    function (value) {
      return typeof value === 'number'
        ? $elm$core$Result$Ok(value)
  ...
  var _Json_decodeValue = _Json_decodePrim(
    function (value) {
      return $elm$core$Result$Ok(_Json_wrap(value));
    },
  );

  var _Json_decodeString = _Json_decodePrim(
    function (value) {
  ...
  var _Json_map7 = F8(
    function (f, d1, d2, d3, d4, d5, d6, d7) {
  ...
  function _Json_runArrayDecoder(
    decoder,
    value,
    toElmValue,
  ) {
  ...
  var _Json_addField = F3(function (key, value, object) {
    ...
    if (
      !(key === 'toJSON' && typeof unwrapped === 'function')
    ) {
  ...
  function _Scheduler_spawn(task) {
    return _Scheduler_binding(function (callback) {
      callback(
        _Scheduler_succeed(_Scheduler_rawSpawn(task)),
      );
    });
  }
...
*/
  ...
  function _Platform_enqueueEffects(
    managers,
    cmdBag,
    subBag,
  ) {
  ...
  function _Platform_dispatchEffects(
    managers,
    cmdBag,
    subBag,
  ) {
  ...
  var _Platform_outgoingPortMap = F2(
  ...
  var _Platform_incomingPortMap = F2(
    function (tagger, finalTagger) {
      return function (value) {
  ...
  var _VirtualDom_keyedNodeNS = F2(
  ...
  var _VirtualDom_keyedNode =
    _VirtualDom_keyedNodeNS(undefined);

  // CUSTOM

  function _VirtualDom_custom(
    factList,
    model,
    render,
    diff,
  ...
  var _VirtualDom_attributeNS = F3(
  ...
  function _VirtualDom_noOnOrFormAction(key) {
    return _VirtualDom_RE_on_formAction.test(key)
      ? 'data-' + key
      : key;
  }
  ...
  var _VirtualDom_mapEventTuple = F2(
    function (func, tuple) {
      return _Utils_Tuple2(func(tuple.a), tuple.b);
    },
  );

  var _VirtualDom_mapEventRecord = F2(
  ...
  function _VirtualDom_render(vNode, eventNode) {
    ...
    if (tag === 4) {
      ...
      var domNode = _VirtualDom_render(
        subNode,
        subEventRoot,
      );
  ...
  function _VirtualDom_applyFacts(
    domNode,
    eventNode,
    facts,
  ) {
  ...
  function _VirtualDom_applyEvents(
    domNode,
    eventNode,
    events,
  ) {
    var allCallbacks =
      domNode.elmFs || (domNode.elmFs = {});
    ...
    for (var key in events) {
      ...
      oldCallback = _VirtualDom_makeCallback(
        eventNode,
        newHandler,
      );
      domNode.addEventListener(
  ...
  function _VirtualDom_makeCallback(
    ...
    function callback(event) {
      ...
      var stopPropagation =
        tag == 1
          ? value.b
          : tag == 3 && value.stopPropagation;
      var currentEventNode =
        (stopPropagation && event.stopPropagation(),
        (tag == 2
          ? value.b
          : tag == 3 && value.preventDefault) &&
  ...
  function _VirtualDom_pushPatch(
    patches,
    type,
    index,
    data,
  ...
  function _VirtualDom_diffHelp(x, y, patches, index) {
    ...
    switch (yType) {
      ...
      case 4:
        ...
        if (
          nesting &&
          xTaggers.length !== yTaggers.length
        ) {
          _VirtualDom_pushPatch(patches, 0, index, y);
          return;
        }
      ...
      case 3:
        ...
        patch &&
          _VirtualDom_pushPatch(patches, 5, index, patch);
  ...
  function _VirtualDom_diffNodes(
    x,
    y,
    patches,
    index,
  ...
  function _VirtualDom_applyPatches(
    ...
    return _VirtualDom_applyPatchesHelp(
      rootDomNode,
      patches,
    );
  }

  function _VirtualDom_applyPatchesHelp(
    rootDomNode,
    patches,
  ) {
    for (var i = 0; i < patches.length; i++) {
      ...
      var newNode = _VirtualDom_applyPatch(
        localDomNode,
        patch,
      );
  ...
  function _VirtualDom_applyPatch(domNode, patch) {
    switch (patch.$) {
      ...
      case 9:
        ...
        entry.s = _VirtualDom_applyPatchesHelp(
          domNode,
          data.w,
        );
        return domNode;
      ...
      case 8:
        return _VirtualDom_applyPatchReorder(
          domNode,
          patch,
        );
    ...
    F4(function (impl, flagDecoder, debugMetadata, args) {
      return _Platform_initialize(
        ...
        function (sendToApp, initialModel) {
          ...
          return _Browser_makeAnimator(
            initialModel,
            function (model) {
              var nextNode = view(model);
              var patches = _VirtualDom_diff(
                currNode,
                nextNode,
              );
  ...
  var _Browser_document =
    ...
    F4(function (impl, flagDecoder, debugMetadata, args) {
      return _Platform_initialize(
        ...
        function (sendToApp, initialModel) {
          var divertHrefToApp =
            impl.setup && impl.setup(sendToApp);
          var view = impl.view;
  ...
  function _Browser_application(impl) {
    ...
    return _Browser_document({
      setup: function (sendToApp) {
        ...
        _Browser_window.navigator.userAgent.indexOf(
          'Trident',
        ) < 0 ||
          _Browser_window.addEventListener(
            'hashchange',
            key,
          );
  ...
  function _Browser_getUrl() {
    return (
      $elm$url$Url$fromString(_VirtualDom_doc.location.href)
        .a || _Debug_crash(1)
    );
  }
  ...
  var _Browser_on = F3(
    function (node, eventName, sendToSelf) {
    ...
    return typeof _VirtualDom_doc.hidden !== 'undefined'
      ...
      : typeof _VirtualDom_doc.mozHidden !== 'undefined'
        ...
        : typeof _VirtualDom_doc.msHidden !== 'undefined'
          ...
          : typeof _VirtualDom_doc.webkitHidden !==
              'undefined'
            ? {
                hidden: 'webkitHidden',
  ...
  var _Regex_replaceAtMost = F4(
    function (n, re, replacer, string) {
      var count = 0;
  ...
  var $elm$json$Json$Decode$errorToString = function (
    error,
  ) {
    return A2(
  ...
  var $elm$core$Elm$JsArray$initialize =
    _JsArray_initialize;
  ...
  var $elm$core$Elm$JsArray$initializeFromList =
      ...
      initializeHelp: while (true) {
        if (fromIndex < 0) {
          return A2($elm$core$Array$builderToArray, false, {
            nodeList: nodeList,
            nodeListSize:
              (len / $elm$core$Array$branchFactor) | 0,
            tail: tail,
          });
        } else {
  ...
  var $elm$virtual_dom$VirtualDom$toHandlerInt = function (
    handler,
  ) {
    switch (handler.$) {
      case 'Normal':
  ...
  var $elm$core$String$left = F2(function (n, string) {
    return n < 1
      ? ''
      : A3($elm$core$String$slice, 0, n, string);
  });
  ...
  var $author$project$Main$initialModel = {
    activeTab: $author$project$Main$DemoTab,
    comparisonPending: false,
    comparisonResults: _List_Nil,
    passthroughText: 'trusted internal value',
    plainText: "Hello <script>alert('XSS')</script> World",
    richText:
      "This is <b>bold</b> and <script>alert('XSS')</script>",
    url: "javascript:alert('XSS')",
  };
  var $elm$core$Platform$Cmd$batch = _Platform_batch;
  var $elm$core$Platform$Cmd$none =
    $elm$core$Platform$Cmd$batch(_List_Nil);
  var $author$project$Main$GotComparisonResults = function (
    a,
  ) {
  ...
  var $author$project$Port$Middleware$receiveComparison =
  ...
  var $author$project$Main$subscriptions = function (_v0) {
    return $author$project$Port$Middleware$receiveComparison(
      $author$project$Main$GotComparisonResults,
    );
  };
  var $author$project$Port$Middleware$AllowSafeHtml = {
    $: 'AllowSafeHtml',
  };
  var $author$project$Port$Middleware$AllowTextOnly = {
    $: 'AllowTextOnly',
  };
  var $author$project$Port$Middleware$AllowUrl = {
    $: 'AllowUrl',
  };
  var $author$project$Main$ComparisonTab = {
    $: 'ComparisonTab',
  };
  var $author$project$Port$Middleware$Passthrough = {
    $: 'Passthrough',
  };
  var $author$project$Tests$cssVectorPayloads =
    _List_fromArray([
      {
        category: 'CSS Vectors',
        id: 'c1',
        input:
      ...
      },
      {
        category: 'CSS Vectors',
        id: 'c3',
        input: '<style>*{x:expression(alert(1))}</style>',
      },
      {
        category: 'CSS Vectors',
        id: 'c4',
        input:
          "<style>@import 'https://evil.com/evil.css'</style>",
      },
      {
        category: 'CSS Vectors',
        id: 'c5',
  ...
  var $author$project$Tests$dangerousTagPayloads =
    _List_fromArray([
      {
      ...
      },
      {
        ...
        id: 'd3',
        input:
          '<embed src=\"https://evil.com/plugin.swf\">',
      },
      {
        category: 'Dangerous Tags',
        id: 'd4',
      ...
      },
      {
        category: 'Dangerous Tags',
        id: 'd9',
        input: '<frame src=\"https://evil.com\">',
      },
      {
        category: 'Dangerous Tags',
        id: 'd10',
        input:
          '<frameset><frame src=\"https://evil.com\"></frameset>',
      },
    ]);
  var $author$project$Tests$encodingPayloads =
    _List_fromArray([
      {
  ...
  var $author$project$Tests$eventHandlerPayloads =
    _List_fromArray([
      {
      ...
      },
      {
        ...
        id: 'e5',
        input:
          '<select onchange=alert(1)><option>a</option></select>',
      },
      {
        category: 'Event Handlers',
        id: 'e6',
      ...
      },
      {
        category: 'Event Handlers',
        id: 'e13',
        input: '<p onmouseenter=alert(1)>text</p>',
      },
      {
        category: 'Event Handlers',
        id: 'e14',
  ...
  var $author$project$Tests$mxssPayloads = _List_fromArray([
    ...
    },
    {
      category: 'mXSS / HTML5',
      id: 'm5',
      input: '<plaintext><img src=x onerror=alert(1)>',
    },
    {
      category: 'mXSS / HTML5',
      id: 'm6',
      input:
        '<p id=\"</p><img src=x onerror=alert(1)>\">test</p>',
    },
    {
      category: 'mXSS / HTML5',
      id: 'm7',
    ...
    },
    {
      ...
      id: 'm8',
      input:
        '<table><td><a href=\"javascript:alert(1)\">click</a></td></table>',
    },
    {
      category: 'mXSS / HTML5',
      id: 'm9',
  ...
  var $author$project$Tests$scriptTagPayloads =
    _List_fromArray([
      {
        ...
        _Utils_ap(
          ...
          _Utils_ap(
            ...
            _Utils_ap(
              ...
              _Utils_ap(
                $author$project$Tests$encodingPayloads,
                $author$project$Tests$safePayloads,
              ),
            ),
          ),
        ),
  ...
  var $author$project$Port$Middleware$requestComparison =
  ...
  var $author$project$Port$HtmlParser$normalizeUrl =
    function (url) {
      return A3(
  ...
  var $author$project$Port$HtmlParser$isSafeUrl = function (
    url,
  ) {
    var normalized =
      $author$project$Port$HtmlParser$normalizeUrl(url);
    ...
    return (
      ...
      !A2($elm$core$String$startsWith, 'data:', lower) &&
      !A2(
        $elm$core$String$startsWith,
        'vbscript:',
        lower,
      ) &&
      !A2($elm$core$String$startsWith, '&#', normalized)
    );
  };
  var $author$project$Port$HtmlParser$TClose = function (
    a,
  ) {
    return { $: 'TClose', a: a };
  };
  ...
  var $author$project$Port$HtmlParser$safeGlobalAttrs =
  ...
  var $author$project$Port$HtmlParser$urlAttrs =
    $elm$core$Set$fromList(
      _List_fromArray(['href', 'src']),
    );
  var $author$project$Port$HtmlParser$filterAttr =
    function (attr) {
      return A2(
        $elm$core$Set$member,
        attr.name,
        $author$project$Port$HtmlParser$urlAttrs,
      )
        ? $author$project$Port$HtmlParser$isSafeUrl(
            attr.value,
          )
          ? $elm$core$Maybe$Just(attr)
          : $elm$core$Maybe$Nothing
        : A2(
              $elm$core$Set$member,
              attr.name,
              $author$project$Port$HtmlParser$safeGlobalAttrs,
            )
          ? $elm$core$Maybe$Just(attr)
          : $elm$core$Maybe$Nothing;
    };
  ...
  var $author$project$Port$HtmlParser$filterAttrs =
    $elm$core$List$filterMap(
      $author$project$Port$HtmlParser$filterAttr,
    );
  var $author$project$Port$HtmlParser$rawTextElements =
    $elm$core$Set$fromList(
      _List_fromArray([
        'script',
        'style',
  ...
  var $author$project$Port$HtmlParser$safeElements =
    $elm$core$Set$fromList(
      _List_fromArray([
        'a',
        'abbr',
              ...
              case 'TClose':
                ...
                if (
                  A2(
                    $elm$core$Set$member,
                    name,
                    $author$project$Port$HtmlParser$safeElements,
                  )
                ) {
                  var $temp$tokens = rest,
                    $temp$skipDepth = 0,
                    ...
                    $temp$acc = A2(
                      $elm$core$List$cons,
                      $author$project$Port$HtmlParser$TClose(
                        name,
                      ),
                      acc,
                    );
              ...
              default:
                ...
                if (
                  A2(
                    $elm$core$Set$member,
                    name,
                    $author$project$Port$HtmlParser$rawTextElements,
                  )
                ) {
                  var $temp$tokens = rest,
                    $temp$skipDepth = 1,
                    ...
                    var $temp$tokens = rest,
                      ...
                      $temp$acc = A2(
                        ...
                        A2(
                          ...
                          name,
                          $author$project$Port$HtmlParser$filterAttrs(
                            attrs,
                          ),
                        ),
                        acc,
  ...
  var $author$project$Port$HtmlParser$filterTokens =
    function (tokens) {
      return A4(
        $author$project$Port$HtmlParser$filterHelp,
        tokens,
        0,
        '',
        _List_Nil,
  ...
  var $author$project$Port$HtmlParser$removeNullBytes = A2(
    $elm$core$String$replace,
    '\u0000',
    '',
  );
  ...
  var $author$project$Port$HtmlParser$escapeAttrValue =
    function (s) {
      return A3(
        $elm$core$String$replace,
        '<',
  ...
  var $author$project$Port$HtmlParser$renderAttr =
    function (attr) {
      return $elm$core$String$isEmpty(attr.value)
        ? attr.name
        : attr.name +
            ('=\"' +
              ($author$project$Port$HtmlParser$escapeAttrValue(
                attr.value,
              ) +
                '\"'));
    };
  var $author$project$Port$HtmlParser$renderAttrs =
    function (attrs) {
      return $elm$core$List$isEmpty(attrs)
        ? ''
        : ' ' +
            A2(
              $elm$core$String$join,
              ...
              A2(
                $elm$core$List$map,
                $author$project$Port$HtmlParser$renderAttr,
                attrs,
              ),
            );
    };
  var $author$project$Port$HtmlParser$renderToken =
    function (tok) {
      switch (tok.$) {
        case 'TText':
          var s = tok.a;
        ...
        case 'TOpen':
          ...
          return (
            '<' +
            (name +
              ($author$project$Port$HtmlParser$renderAttrs(
                attrs,
              ) +
                '>'))
          );
  ...
  var $author$project$Port$HtmlParser$renderTokens =
    function (tokens) {
      return $elm$core$String$concat(
        A2(
          $elm$core$List$map,
          $author$project$Port$HtmlParser$renderToken,
          tokens,
        ),
      );
    };
  ...
  var $author$project$Port$HtmlParser$countPrefix = F2(
    function (pred, str) {
      ...
      return A2(go, $elm$core$String$toList(str), 0);
    },
  );
  var $author$project$Port$HtmlParser$consumeWhile = F2(
    function (pred, str) {
      var n = A2(
        $author$project$Port$HtmlParser$countPrefix,
        pred,
        str,
      );
  ...
  var $author$project$Port$HtmlParser$isNameChar =
    function (c) {
      return (
        $elm$core$Char$isAlphaNum(c) ||
        _Utils_eq(c, _Utils_chr('_')) ||
        _Utils_eq(c, _Utils_chr(':')) ||
        _Utils_eq(c, _Utils_chr('-')) ||
        _Utils_eq(c, _Utils_chr('.'))
      );
    };
  var $author$project$Port$HtmlParser$consumeTagName =
    $author$project$Port$HtmlParser$consumeWhile(
      $author$project$Port$HtmlParser$isNameChar,
    );
  ...
  var $author$project$Port$HtmlParser$findAfterCommentEnd =
    function (str) {
      var _v0 = A2($elm$core$String$indexes, '-->', str);
      if (!_v0.b) {
        return '';
  ...
  var $author$project$Port$HtmlParser$isNameStartChar =
    function (c) {
      return (
  ...
  var $author$project$Port$HtmlParser$isWhitespace =
    function (c) {
      return (
        _Utils_eq(c, _Utils_chr(' ')) ||
        _Utils_eq(c, _Utils_chr('\t')) ||
  ...
  var $author$project$Port$HtmlParser$isAttrNameChar =
    function (c) {
      return (
        !$author$project$Port$HtmlParser$isWhitespace(c) &&
        !_Utils_eq(c, _Utils_chr('=')) &&
        !_Utils_eq(c, _Utils_chr('>')) &&
        !_Utils_eq(c, _Utils_chr('/')) &&
        !_Utils_eq(c, _Utils_chr('\"')) &&
  ...
  var $author$project$Port$HtmlParser$isUnquotedValueChar =
    function (c) {
      return (
        !$author$project$Port$HtmlParser$isWhitespace(c) &&
        !_Utils_eq(c, _Utils_chr('>')) &&
  ...
  var $author$project$Port$HtmlParser$parseAttrValue =
    function (str) {
      ...
      return A2(
        $author$project$Port$HtmlParser$consumeWhile,
        $author$project$Port$HtmlParser$isUnquotedValueChar,
        str,
      );
    };
  ...
  var $author$project$Port$HtmlParser$skipWs = function (
    str,
  ) {
    return A2(
      $author$project$Port$HtmlParser$consumeWhile,
      $author$project$Port$HtmlParser$isWhitespace,
      str,
    ).b;
  };
  var $author$project$Port$HtmlParser$parseOneAttr =
    function (str) {
      var _v0 = A2(
        $author$project$Port$HtmlParser$consumeWhile,
        $author$project$Port$HtmlParser$isAttrNameChar,
        str,
      );
      var rawName = _v0.a;
      var afterName = _v0.b;
      var trimmed =
        $author$project$Port$HtmlParser$skipWs(afterName);
      ...
      if (_v1.$ === 'Just' && '=' === _v1.a.a.valueOf()) {
        ...
        var afterEq = _v2.b;
        var _v3 =
          $author$project$Port$HtmlParser$parseAttrValue(
      ...
      parseAttrsLoop: while (true) {
        ...
        if (_v0.$ === 'Nothing') {
          ...
          switch (_v0.a.a.valueOf()) {
            ...
            default:
              var _v5 =
                $author$project$Port$HtmlParser$parseOneAttr(
                  str,
                );
              var attr = _v5.a;
              var afterAttr = _v5.b;
              if (
                $elm$core$String$isEmpty(attr.name) &&
                _Utils_eq(afterAttr, str)
              ) {
                return _Utils_Tuple2(
                  $elm$core$List$reverse(acc),
                  A2(
                ...
                var $temp$str =
                    $author$project$Port$HtmlParser$skipWs(
                      afterAttr,
                    ),
                  $temp$acc = A2(
                    $elm$core$List$cons,
  ...
  var $author$project$Port$HtmlParser$parseAttrs =
    function (str) {
      return A2(
  ...
  var $author$project$Port$HtmlParser$parseTagToken =
    function (rest) {
      ...
      if (_v0.$ === 'Nothing') {
        ...
        switch (_v0.a.a.valueOf()) {
          ...
          case '/':
            ...
            var _v3 =
              $author$project$Port$HtmlParser$consumeTagName(
                afterSlash,
              );
            var rawName = _v3.a;
            var afterName = _v3.b;
          ...
          default:
            ...
            var ch = _v4.a;
            if (
              $author$project$Port$HtmlParser$isNameStartChar(
                ch,
              )
            ) {
              var _v5 =
              ...
              var name = $elm$core$String$toLower(rawName);
              var _v6 =
                $author$project$Port$HtmlParser$parseAttrs(
                  afterName,
                );
              var attrs = _v6.a;
              var after = _v6.b;
      ...
      tokenizeLoop: while (true) {
        ...
        if (_v0.$ === 'Nothing') {
          ...
          if ('<' === _v0.a.a.valueOf()) {
            ...
            var rest = _v1.b;
            var _v2 =
              $author$project$Port$HtmlParser$parseTagToken(
                rest,
              );
            var tok = _v2.a;
            var after = _v2.b;
  ...
  var $author$project$Port$HtmlParser$tokenize = function (
    src,
  ) {
    return A2(
      $author$project$Port$HtmlParser$tokenizeLoop,
      src,
      _List_Nil,
    );
  };
  var $author$project$Port$HtmlParser$sanitize = function (
    input,
  ) {
    return $author$project$Port$HtmlParser$renderTokens(
      $author$project$Port$HtmlParser$filterTokens(
        $author$project$Port$HtmlParser$tokenize(
          $author$project$Port$HtmlParser$removeNullBytes(
            input,
          ),
        ),
      ),
  ...
  var $author$project$Port$HtmlParser$extractText =
    function (tok) {
      if (tok.$ === 'TText') {
        var s = tok.a;
  ...
  var $author$project$Port$HtmlParser$htmlEncode =
    function (s) {
      return A3(
        $elm$core$String$replace,
        "'",
  ...
  var $author$project$Port$HtmlParser$stripToText =
    function (input) {
  ...
  var $author$project$Port$Middleware$sanitize = F2(
    function (policy, rawString) {
      switch (policy.$) {
        case 'AllowTextOnly':
          return $author$project$Port$HtmlParser$stripToText(
            rawString,
          );
        case 'AllowSafeHtml':
          return $author$project$Port$HtmlParser$sanitize(
            rawString,
          );
        case 'AllowUrl':
          return $author$project$Port$HtmlParser$isSafeUrl(
            rawString,
          )
            ? rawString
            : '';
  ...
  var $elm$regex$Regex$fromStringWith =
    _Regex_fromStringWith;
  ...
  var $author$project$Port$Middleware$dangerousTagPattern =
    A2(
  ...
  var $author$project$Port$Middleware$eventHandlerPattern =
    A2(
      $elm$core$Maybe$withDefault,
      $elm$regex$Regex$never,
      A2(
  ...
  var $author$project$Port$Middleware$htmlEntityStartPattern =
    A2(
      $elm$core$Maybe$withDefault,
      $elm$regex$Regex$never,
      $elm$regex$Regex$fromString('^&#'),
    );
  var $author$project$Port$Middleware$normalizeUrl =
    function (url) {
      return A3(
        $elm$core$String$replace,
        '\r',
  ...
  var $author$project$Port$Middleware$isSafeUrl = function (
    url,
  ) {
    var normalized =
      $author$project$Port$Middleware$normalizeUrl(url);
    var lower = $elm$core$String$toLower(normalized);
    return (
      !A2(
        $elm$core$String$startsWith,
      ...
      !A2(
        ...
        $author$project$Port$Middleware$htmlEntityStartPattern,
        normalized,
      )
    );
  };
  ...
  var $author$project$Port$Middleware$removeNullBytes = A2(
    $elm$core$String$replace,
    '\u0000',
    '',
  );
  var $elm$regex$Regex$replace =
    _Regex_replaceAtMost(_Regex_infinity);
  ...
  var $author$project$Port$Middleware$sanitizeRegex = F2(
    function (policy, rawString) {
      switch (policy.$) {
        case 'AllowTextOnly':
          return A3(
                ...
                A3(
                  ...
                  A3(
                    ...
                    A3(
                      ...
                      $author$project$Port$Middleware$removeNullBytes(
                        rawString,
                      ),
                    ),
                  ),
        ...
        case 'AllowUrl':
          return $author$project$Port$Middleware$isSafeUrl(
            rawString,
          )
            ? rawString
            : '';
  ...
  var $author$project$Port$Middleware$policyToString =
    function (policy) {
      switch (policy.$) {
        case 'AllowTextOnly':
          return 'text-only';
  ...
  var $author$project$Port$Middleware$sendToJS =
    _Platform_outgoingPort('sendToJS', function ($) {
      return $elm$json$Json$Encode$object(
        _List_fromArray([
          _Utils_Tuple2(
            'data',
  ...
  var $author$project$Port$Middleware$send = F2(
    function (policy, payload) {
      return $author$project$Port$Middleware$sendToJS({
        data: payload,
        policy:
          $author$project$Port$Middleware$policyToString(
            policy,
          ),
      });
    },
  ...
  var $author$project$Port$Middleware$sendString = F2(
    function (policy, rawString) {
      var safeString = A2(
        $author$project$Port$Middleware$sanitize,
        policy,
        rawString,
      );
      return $author$project$Port$Middleware$sendToJS({
        data: $elm$json$Json$Encode$string(safeString),
        policy:
          $author$project$Port$Middleware$policyToString(
            policy,
          ),
    ...
    function (msg, model) {
      switch (msg.$) {
        case 'UpdatePlainText':
          var str = msg.a;
          return _Utils_Tuple2(
            _Utils_update(model, { plainText: str }),
            $elm$core$Platform$Cmd$none,
          );
        case 'UpdateRichText':
          var str = msg.a;
          return _Utils_Tuple2(
            _Utils_update(model, { richText: str }),
            $elm$core$Platform$Cmd$none,
          );
        case 'UpdateUrl':
          var str = msg.a;
          return _Utils_Tuple2(
            _Utils_update(model, { url: str }),
            $elm$core$Platform$Cmd$none,
          );
        case 'UpdatePassthrough':
          var str = msg.a;
          return _Utils_Tuple2(
            _Utils_update(model, { passthroughText: str }),
            $elm$core$Platform$Cmd$none,
          );
        case 'SendPlainText':
          return _Utils_Tuple2(
            model,
            A2(
              $author$project$Port$Middleware$sendString,
              $author$project$Port$Middleware$AllowTextOnly,
              model.plainText,
            ),
          );
        case 'SendRichText':
          return _Utils_Tuple2(
            ...
            A2(
              $author$project$Port$Middleware$sendString,
              $author$project$Port$Middleware$AllowSafeHtml,
              model.richText,
            ),
          );
        case 'SendUrl':
          return _Utils_Tuple2(
            ...
            A2(
              $author$project$Port$Middleware$sendString,
              $author$project$Port$Middleware$AllowUrl,
              model.url,
            ),
          );
        ...
        case 'SetTab':
          if (msg.a.$ === 'ComparisonTab') {
            var _v1 = msg.a;
            var payloads =
              $author$project$Tests$comparisonPayloads;
            var portPayloads = A2(
              $elm$core$List$map,
              function (p) {
            ...
            var elmResults = A2(
              ...
              function (p) {
                return {
                  ...
                  input: p.input,
                  regexSafeHtml: A2(
                    $author$project$Port$Middleware$sanitizeRegex,
                    $author$project$Port$Middleware$AllowSafeHtml,
                    p.input,
                  ),
                  regexTextOnly: A2(
            ...
            return _Utils_Tuple2(
              _Utils_update(model, {
                activeTab:
                  $author$project$Main$ComparisonTab,
                comparisonPending: true,
                comparisonResults: elmResults,
              }),
              $author$project$Port$Middleware$requestComparison(
                portPayloads,
              ),
            );
          } else {
            var tab = msg.a;
            return _Utils_Tuple2(
              _Utils_update(model, { activeTab: tab }),
              $elm$core$Platform$Cmd$none,
            );
          }
        default:
            ...
            function (r) {
              ...
              if (_v2.$ === 'Just') {
                ...
                return _Utils_update(r, {
                  dpSafeHtml: dp.safeHtml,
                  dpTextOnly: dp.textOnly,
                });
              } else {
                return r;
              }
  ...
  var $author$project$Tests$allowSafeHtmlTests =
    _List_fromArray([
      {
        ...
        policy:
          $author$project$Port$Middleware$AllowSafeHtml,
        shouldBlock: _List_fromArray(['<script']),
        shouldPass: _List_fromArray(['<b>']),
      },
      {
        category: 'AllowSafeHtml',
        description:
          'Strips uppercase <SCRIPT> (case obfuscation)',
        input: '<SCRIPT>alert(1)</SCRIPT>',
        policy:
          $author$project$Port$Middleware$AllowSafeHtml,
        shouldBlock: _List_fromArray(['script']),
      ...
      },
      {
        ...
        policy:
          $author$project$Port$Middleware$AllowSafeHtml,
        shouldBlock: _List_fromArray(['script', 'alert']),
        shouldPass: _List_Nil,
      },
      {
        category: 'AllowSafeHtml',
        description:
          'Strips onerror= event handler on <img>',
        input: '<img src=x onerror=alert(1)>',
        policy:
          $author$project$Port$Middleware$AllowSafeHtml,
        shouldBlock: _List_fromArray(['onerror']),
        shouldPass: _List_Nil,
      },
      {
        category: 'AllowSafeHtml',
        description:
          'Strips mixed-case onMouseOver= (case obfuscation)',
        input: '<div onMouseOver=alert(1)>hover</div>',
        policy:
          $author$project$Port$Middleware$AllowSafeHtml,
        shouldBlock: _List_fromArray(['onmouseover']),
        shouldPass: _List_Nil,
      },
      {
        category: 'AllowSafeHtml',
        description:
          'Strips onclick with space before = (whitespace obfuscation)',
        input: '<div onclick =alert(1)>click</div>',
        policy:
          $author$project$Port$Middleware$AllowSafeHtml,
        shouldBlock: _List_fromArray(['onclick']),
        shouldPass: _List_Nil,
      },
      {
        category: 'AllowSafeHtml',
        ...
        policy:
          $author$project$Port$Middleware$AllowSafeHtml,
        shouldBlock: _List_fromArray(['<iframe']),
        shouldPass: _List_Nil,
      },
      {
        category: 'AllowSafeHtml',
        ...
        policy:
          $author$project$Port$Middleware$AllowSafeHtml,
        shouldBlock: _List_fromArray(['<svg', 'onload']),
        shouldPass: _List_Nil,
      },
      {
        category: 'AllowSafeHtml',
        description:
          'Strips javascript: in href attribute, keeps <a> element',
        input: '<a href=\"javascript:alert(1)\">click</a>',
        policy:
          $author$project$Port$Middleware$AllowSafeHtml,
        shouldBlock: _List_fromArray(['javascript:']),
        shouldPass: _List_fromArray(['<a>']),
      },
      {
        category: 'AllowSafeHtml',
        ...
        policy:
          $author$project$Port$Middleware$AllowSafeHtml,
        shouldBlock: _List_fromArray(['<object']),
        shouldPass: _List_Nil,
      },
      {
        category: 'AllowSafeHtml',
        ...
        policy:
          $author$project$Port$Middleware$AllowSafeHtml,
        shouldBlock: _List_fromArray(['<meta']),
        shouldPass: _List_Nil,
      },
      {
        category: 'AllowSafeHtml',
        ...
        input:
          '<p>A <b>bold</b> and <i>italic</i> paragraph.</p>',
        policy:
          $author$project$Port$Middleware$AllowSafeHtml,
        shouldBlock: _List_Nil,
        shouldPass: _List_fromArray(['<b>', '<i>', '<p>']),
      },
      {
        category: 'AllowSafeHtml',
        ...
        policy:
          $author$project$Port$Middleware$AllowSafeHtml,
        shouldBlock: _List_fromArray(['<embed']),
        shouldPass: _List_Nil,
      },
      {
        category: 'AllowSafeHtml',
        description:
          'Parser: drops on* attr, preserves safe attrs on same tag',
        input:
          '<span class=\"note\" onclick=\"alert(1)\" title=\"ok\">text</span>',
        policy:
          $author$project$Port$Middleware$AllowSafeHtml,
        shouldBlock: _List_fromArray(['onclick']),
      ...
      },
      {
        category: 'AllowSafeHtml',
        description:
          'Parser: javascript: href with surrounding whitespace',
      ...
      },
      {
        ...
        policy:
          $author$project$Port$Middleware$AllowSafeHtml,
        shouldBlock: _List_fromArray(['data:']),
        shouldPass: _List_fromArray(['alt=\"x\"']),
      },
      {
        category: 'AllowSafeHtml',
        description:
          'Parser: nested <svg> inside safe HTML drops both svg blocks',
        input:
          '<p>hello</p><svg><svg onload=\"alert(1)\"></svg></svg><p>world</p>',
        policy:
          $author$project$Port$Middleware$AllowSafeHtml,
      ...
      },
      {
        category: 'AllowSafeHtml',
        description:
          'Parser: unknown element tag is dropped but text child is kept',
        input: '<custom-widget>safe text</custom-widget>',
        policy:
          $author$project$Port$Middleware$AllowSafeHtml,
        shouldBlock: _List_fromArray(['<custom-widget']),
        shouldPass: _List_fromArray(['safe text']),
      },
      {
        category: 'AllowSafeHtml',
        description:
          'Parser: safe https: src on img is kept',
        input:
  ...
  var $author$project$Tests$allowTextOnlyTests =
    _List_fromArray([
      {
      ...
      },
      {
        ...
        policy:
          $author$project$Port$Middleware$AllowTextOnly,
        shouldBlock: _List_fromArray(['<img', 'onerror']),
        shouldPass: _List_Nil,
      },
      {
        category: 'AllowTextOnly',
        description:
          'Strips safe <b> tag (no tags allowed)',
        input: '<b>bold</b>',
        policy:
          $author$project$Port$Middleware$AllowTextOnly,
        shouldBlock: _List_fromArray(['<b>']),
        shouldPass: _List_fromArray(['bold']),
      },
      {
        category: 'AllowTextOnly',
        ...
        policy:
          $author$project$Port$Middleware$AllowTextOnly,
        shouldBlock: _List_Nil,
        shouldPass: _List_fromArray(['cats &amp; dogs']),
      },
      {
        category: 'AllowTextOnly',
      ...
      },
      {
        category: 'AllowTextOnly',
        description:
          'Obfuscation: tag with embedded newline <scr\\nipt>',
        input: '<scr\nipt>alert(1)</scr\nipt>',
        policy:
          $author$project$Port$Middleware$AllowTextOnly,
        shouldBlock: _List_fromArray(['<scr']),
        shouldPass: _List_Nil,
      },
      {
        category: 'AllowTextOnly',
        ...
        policy:
          $author$project$Port$Middleware$AllowTextOnly,
        shouldBlock: _List_fromArray(['alert']),
        shouldPass: _List_Nil,
      },
      {
        category: 'AllowTextOnly',
        ...
        policy:
          $author$project$Port$Middleware$AllowTextOnly,
        shouldBlock: _List_Nil,
        shouldPass: _List_fromArray(['Hello, World!']),
      },
      {
        category: 'AllowTextOnly',
        description:
          'Strips double-bracket trick <<script>',
        input: '<<script>alert(1)<</script>',
        policy:
          $author$project$Port$Middleware$AllowTextOnly,
        shouldBlock: _List_fromArray(['<script', 'alert']),
  ...
  var $author$project$Tests$allowUrlTests = _List_fromArray(
    [
      {
        category: 'AllowUrl',
        description: 'Blocks javascript: scheme',
        input: 'javascript:alert(1)',
        policy: $author$project$Port$Middleware$AllowUrl,
        shouldBlock: _List_fromArray(['javascript']),
        shouldPass: _List_Nil,
      },
      {
      ...
      },
      {
        ...
        policy: $author$project$Port$Middleware$AllowUrl,
        shouldBlock: _List_fromArray(['vbscript']),
        shouldPass: _List_Nil,
      },
      {
        category: 'AllowUrl',
        description:
          'Blocks JAVASCRIPT: (uppercase obfuscation)',
        input: 'JAVASCRIPT:alert(1)',
        policy: $author$project$Port$Middleware$AllowUrl,
        shouldBlock: _List_fromArray(['javascript']),
        shouldPass: _List_Nil,
      },
      {
        category: 'AllowUrl',
        description:
          'Obfuscation: java\\tscript: (tab-separated)',
      ...
      },
      {
        category: 'AllowUrl',
        description:
          'Obfuscation: java\\rscript: (CR-split)',
      ...
      },
      {
        category: 'AllowUrl',
        description:
          'Obfuscation: java\\u{0000}script: (null byte)',
        input: 'java\u0000script:alert(1)',
        policy: $author$project$Port$Middleware$AllowUrl,
        shouldBlock: _List_fromArray(['javascript']),
        shouldPass: _List_Nil,
      },
      {
        category: 'AllowUrl',
        description:
          'Obfuscation: &#106;avascript: (entity-encoded j)',
        input: '&#106;avascript:alert(1)',
        policy: $author$project$Port$Middleware$AllowUrl,
        shouldBlock: _List_fromArray([
          'javascript',
      ...
      },
      {
        category: 'AllowUrl',
        description:
          'Obfuscation: leading whitespace before javascript:',
        input: '   javascript:alert(1)',
        policy: $author$project$Port$Middleware$AllowUrl,
        shouldBlock: _List_fromArray(['javascript']),
        shouldPass: _List_Nil,
      ...
      },
      {
        ...
        policy: $author$project$Port$Middleware$AllowUrl,
        shouldBlock: _List_Nil,
        shouldPass: _List_fromArray(['/images/photo.jpg']),
      },
      {
        category: 'AllowUrl',
  ...
  var $author$project$Tests$allTests = _Utils_ap(
    $author$project$Tests$allowTextOnlyTests,
    _Utils_ap(
      $author$project$Tests$allowSafeHtmlTests,
      $author$project$Tests$allowUrlTests,
    ),
  );
  ...
  var $author$project$Tests$runTest = function (tc) {
    ...
    var passViolations = A2(
      $elm$core$List$map,
      function (s) {
        return 'Missing expected: \"' + (s + '\"');
      },
      A2(
        $elm$core$List$filter,
        function (s) {
          return !A2($elm$core$String$contains, s, output);
        },
        tc.shouldPass,
      ),
    );
    var blockViolations = A2(
      $elm$core$List$map,
      function (s) {
        return 'Still contains: \"' + (s + '\"');
      },
      A2(
        $elm$core$List$filter,
        function (s) {
    ...
    return {
      failures: failures,
      output: output,
      passed: $elm$core$List$isEmpty(failures),
      testCase: tc,
    };
  };
  var $author$project$Tests$runAllTests = A2(
    $elm$core$List$map,
    $author$project$Tests$runTest,
    $author$project$Tests$allTests,
  );
  var $elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
  var $elm$html$Html$Attributes$style =
  ...
  var $author$project$Main$tabButton = F3(
    function (tab, label, activeTab) {
      ...
      var activeStyles = _List_fromArray([
        A2(
          $elm$html$Html$Attributes$style,
          'border-bottom',
          '2px solid #2563eb',
      ...
      return A2(
        ...
        _Utils_ap(
          baseStyles,
          _Utils_ap(
            isActive ? activeStyles : _List_Nil,
            _List_fromArray([
              $elm$html$Html$Events$onClick(
                $author$project$Main$SetTab(tab),
              ),
            ]),
          ),
        ),
  ...
  var $author$project$Main$viewComparisonNote = A2(
    ...
    _List_fromArray([
      $elm$html$Html$text(
        '85 curated XSS payloads from OWASP, PortSwigger, and mXSS research — run through both sanitizers. ',
      ),
      $elm$html$Html$text(
        '\"Match\" means the sanitized output strings are identical. ',
      ),
      $elm$html$Html$text(
        "Divergences in AllowSafeHtml vs DOMPurify reveal coverage gaps between the regex-based Elm approach and DOMPurify's DOM-parser-based sanitization.",
      ),
    ]),
  );
  ...
  var $author$project$Main$computeMatrix = function (rows) {
    return A3(
      $elm$core$List$foldl,
      F2(function (r, acc) {
        var outputsMatch = _Utils_eq(
          r.elmOutput,
          r.dpOutput,
        );
        var elmBlocked = !_Utils_eq(r.elmOutput, r.input);
        return elmBlocked && outputsMatch
          ? _Utils_update(acc, { tp: acc.tp + 1 })
          : elmBlocked && !outputsMatch
            ? _Utils_update(acc, { fp: acc.fp + 1 })
            : !elmBlocked && !outputsMatch
              ? _Utils_update(acc, { fn: acc.fn + 1 })
              : _Utils_update(acc, { tn: acc.tn + 1 });
      }),
      { fn: 0, fp: 0, tn: 0, tp: 0 },
      rows,
    );
  ...
  var $author$project$Main$truncate = F2(
    function (maxLen, s) {
      return _Utils_cmp(
        ...
        ? A2($elm$core$String$left, maxLen, s) + '…'
        : s;
    },
  );
  var $author$project$Main$viewComparisonRow = function (
    row,
  ) {
    var regexMatch = _Utils_eq(
      row.regexOutput,
      row.dpOutput,
    );
    var outputCell = function (s) {
      return A2(
        $elm$html$Html$td,
        _List_fromArray([
          A2(
        ...
        _List_fromArray([
          A2(
            ...
            _List_fromArray([
              $elm$html$Html$text(
                $elm$core$String$isEmpty(s)
                  ? '(empty)'
                  : A2(
                      $author$project$Main$truncate,
                      40,
                      s,
                    ),
              ),
    ...
    var hpMatch = _Utils_eq(row.hpOutput, row.dpOutput);
    var rowBg = regexMatch && hpMatch ? 'white' : '#fffbeb';
    ...
    return A2(
      ...
      _List_fromArray([
        ...
        outputCell(row.regexOutput),
        outputCell(row.hpOutput),
        outputCell(row.dpOutput),
        matchCell(regexMatch),
        matchCell(hpMatch),
      ]),
    );
  };
  var $author$project$Main$computePrecision = function (m) {
    return !(m.tp + m.fp)
      ? $elm$core$Maybe$Nothing
      : $elm$core$Maybe$Just(m.tp / (m.tp + m.fp));
  };
  var $author$project$Main$computeRecall = function (m) {
    return !(m.tp + m.fn)
      ? $elm$core$Maybe$Nothing
      : $elm$core$Maybe$Just(m.tp / (m.tp + m.fn));
  };
  ...
  var $author$project$Main$formatPct = function (mf) {
    if (mf.$ === 'Nothing') {
      ...
      var frac = $elm$core$Basics$round(
        (pct - intPart) * 10,
      );
      return (
        $elm$core$String$fromInt(intPart) +
        ('.' + ($elm$core$String$fromInt(frac) + '%'))
      );
    }
  };
  var $author$project$Main$viewConfusionMatrix = F2(
    function (label, m) {
      return A2(
        $elm$html$Html$div,
        _List_Nil,
      ...
      return A2(
        ...
        _List_fromArray([
          ...
          A2(
            ...
            _List_fromArray([$elm$html$Html$text(value)]),
          ),
          A2(
            $elm$html$Html$div,
            _List_fromArray([
            ...
            _List_fromArray([$elm$html$Html$text(formula)]),
          ),
          A2(
            $elm$html$Html$div,
            _List_fromArray([
  ...
  var $author$project$Main$viewMetricsPanel = F2(
    function (label, m) {
      ...
      return A2(
        ...
        _List_fromArray([
          A2(
            $author$project$Main$viewConfusionMatrix,
            label,
            m,
          ),
          A2(
            ...
            _List_fromArray([
              A2(
                ...
                _List_fromArray([
                  $elm$html$Html$text(
                    'Metrics (DOMPurify = ground truth)',
                  ),
                ]),
              ),
              A2(
                ...
                _List_fromArray([
                  A4(
                    ...
                    'Of ' +
                      (label +
                        "'s blocks, what fraction produced the exact same output as DOMPurify."),
                  ),
                  A4(
                    $author$project$Main$viewMetricCard,
                    'Recall',
                    ...
                    'TP / (TP+FN)',
                    'Of cases where outputs differed, what fraction did ' +
                      (label +
                        ' block with matching output.'),
                  ),
                  A4(
                    $author$project$Main$viewMetricCard,
                    'F1 Score',
  ...
  var $author$project$Main$viewComparisonSection = F4(
    function (title, color, note, rows) {
      ...
      var regexMatrix =
        $author$project$Main$computeMatrix(regexRows);
      var regexMatchCount = $elm$core$List$length(
        A2(
          $elm$core$List$filter,
          function (r) {
            return _Utils_eq(r.regexOutput, r.dpOutput);
          },
          rows,
        ),
      );
      var regexDivergeCount = total - regexMatchCount;
      var hpRows = A2(
        $elm$core$List$map,
        function (r) {
          return {
            dpOutput: r.dpOutput,
            elmOutput: r.hpOutput,
            input: r.input,
          };
        },
        rows,
      ...
      var hpMatrix =
        $author$project$Main$computeMatrix(hpRows);
      var hpMatchCount = $elm$core$List$length(
        A2(
          $elm$core$List$filter,
          function (r) {
            return _Utils_eq(r.hpOutput, r.dpOutput);
          },
          rows,
        ),
      );
      var hpDivergeCount = total - hpMatchCount;
      return A2(
        $elm$html$Html$div,
        _List_fromArray([
          A2(
        ...
        _List_fromArray([
          ...
          A2(
            ...
            _List_fromArray([$elm$html$Html$text(note)]),
          ),
          A2(
            $elm$html$Html$div,
            _List_fromArray([
            ...
            _List_fromArray([
              A2(
                ...
                _List_fromArray([
                  ...
                  A2(
                    $author$project$Main$viewMetricsPanel,
                    'Regex',
                    regexMatrix,
                  ),
                ]),
              ...
              A2(
                ...
                _List_fromArray([
                  ...
                  A2(
                    ...
                    A2(
                      $elm$core$List$map,
                      $author$project$Main$viewComparisonRow,
                      rows,
                    ),
                  ),
                ]),
  ...
  var $author$project$Main$viewComparison = function (
    model,
  ) {
    return model.comparisonPending
      ? A2(
          $elm$html$Html$div,
          _List_fromArray([
            A2(
          ...
          _List_fromArray([
            ...
            A2(
              ...
              _List_fromArray([
                $elm$html$Html$text(
                  'Waiting for JavaScript port response.',
                ),
              ]),
            ),
          ]),
        )
      : $elm$core$List$isEmpty(model.comparisonResults)
        ? A2(
            $elm$html$Html$div,
            _List_fromArray([
              A2(
            ...
            _List_fromArray([
              $elm$html$Html$text(
                'Switch to this tab to run the comparison.',
              ),
            ]),
          )
        : A2(
              ...
              A4(
                ...
                A2(
                  ...
                  function (r) {
                    return {
                      category: r.category,
                      dpOutput: r.dpTextOnly,
                      hpOutput: r.hpTextOnly,
                      input: r.input,
                      regexOutput: r.regexTextOnly,
                    };
                  },
                  model.comparisonResults,
                ),
              ...
              A4(
                ...
                A2(
                  ...
                  function (r) {
                    return {
                      category: r.category,
                      dpOutput: r.dpSafeHtml,
                      hpOutput: r.hpSafeHtml,
                      input: r.input,
                      regexOutput: r.regexSafeHtml,
                    };
                  },
                  model.comparisonResults,
                ),
  ...
  var $author$project$Main$SendPassThrough = {
    $: 'SendPassThrough',
  };
  var $author$project$Main$SendPlainText = {
    $: 'SendPlainText',
  };
  var $author$project$Main$SendRichText = {
    $: 'SendRichText',
  };
  var $author$project$Main$SendUrl = { $: 'SendUrl' };
  var $author$project$Main$UpdatePassthrough = function (
    a,
  ) {
  ...
  var $author$project$Main$UpdateRichText = function (a) {
    return { $: 'UpdateRichText', a: a };
  };
  var $author$project$Main$UpdateUrl = function (a) {
    return { $: 'UpdateUrl', a: a };
  };
  var $author$project$Main$demoButton = F3(
    function (label, msg, color) {
      return A2(
        $elm$html$Html$button,
        _List_fromArray([
  ...
  var $author$project$Main$demoInput = F3(
    function (ph, val, handler) {
      return A2(
        $elm$html$Html$input,
        _List_fromArray([
  ...
  var $author$project$Main$viewDemo = function (model) {
    return A2(
      ...
      _List_fromArray([
        A5(
          $author$project$Main$policyCard,
          '1',
          'AllowTextOnly',
          '#dc2626',
          ...
          _List_fromArray([
            A3(
              ...
              'Enter text (try XSS payloads)',
              model.plainText,
              $author$project$Main$UpdatePlainText,
            ),
            A3(
              $author$project$Main$demoButton,
              'Send with AllowTextOnly',
              $author$project$Main$SendPlainText,
              '#dc2626',
            ),
          ]),
        ),
        A5(
          ...
          _List_fromArray([
            A3(
              ...
              'Enter HTML content',
              model.richText,
              $author$project$Main$UpdateRichText,
            ),
            A3(
              $author$project$Main$demoButton,
              'Send with AllowSafeHtml',
              $author$project$Main$SendRichText,
              '#d97706',
            ),
          ]),
        ),
        ...
        A5(
          ...
          _List_fromArray([
            A3(
              ...
              'Enter trusted value',
              model.passthroughText,
              $author$project$Main$UpdatePassthrough,
            ),
            A3(
              $author$project$Main$demoButton,
              'Send with Passthrough',
              $author$project$Main$SendPassThrough,
              '#16a34a',
            ),
          ]),
        ),
  ...
  var $author$project$Tests$passCount = A2(
    $elm$core$Basics$composeL,
    $elm$core$List$length,
    $elm$core$List$filter(function ($) {
      return $.passed;
    }),
  );
  var $author$project$Tests$failCount = function (results) {
    return (
      ...
      $author$project$Tests$passCount(results)
    );
  };
  ...
  var $author$project$Main$viewTestRow = function (result) {
    var passColor = result.passed ? '#f0fdf4' : '#fef2f2';
    var iconColor = result.passed ? '#16a34a' : '#dc2626';
    var icon = result.passed ? 'PASS' : 'FAIL';
    var borderColor = result.passed ? '#bbf7d0' : '#fecaca';
    return A2(
      $elm$html$Html$div,
      _List_fromArray([
        A2(
        ...
        A2(
          ...
          _List_fromArray([
            A2(
              ...
              _List_fromArray([$elm$html$Html$text(icon)]),
            ),
            A2(
              $elm$html$Html$div,
              _List_fromArray([
              ...
              _List_fromArray([
                ...
                A2(
                  ...
                  _List_fromArray([
                    A2(
                      $author$project$Main$codeSnippet,
                      'IN',
  ...
  var $author$project$Main$viewTestGroup = F2(
    function (category, results) {
      var total = $elm$core$List$length(results);
      var passed = $author$project$Tests$passCount(results);
      var color = (function () {
        switch (category) {
          case 'AllowTextOnly':
            return '#dc2626';
      ...
      return A2(
        ...
        _List_fromArray([
          ...
          A2(
            ...
            A2(
              $elm$core$List$map,
              $author$project$Main$viewTestRow,
              results,
            ),
          ),
        ]),
  ...
  var $author$project$Main$viewTestGroups = function (
    results,
  ) {
    ...
    return A2(
      ...
      function (cat) {
        return A2(
          $author$project$Main$viewTestGroup,
          cat,
          A2(
            $elm$core$List$filter,
            function (r) {
              return _Utils_eq(r.testCase.category, cat);
            },
            results,
          ),
        );
  ...
  var $author$project$Main$viewTests = function (results) {
    var total = $elm$core$List$length(results);
    var passed = $author$project$Tests$passCount(results);
    var failed = $author$project$Tests$failCount(results);
    return A2(
      $elm$html$Html$div,
      _List_Nil,
      _List_fromArray([
        A2(
          ...
          _List_fromArray([
            ...
            A2(
              $elm$html$Html$Attributes$style,
              'background',
              !failed ? '#f0fdf4' : '#fef2f2',
            ),
            A2(
              $elm$html$Html$Attributes$style,
              'border',
              '1px solid ' +
                (!failed ? '#bbf7d0' : '#fecaca'),
            ),
            A2(
              $elm$html$Html$Attributes$style,
              'border-radius',
          ...
          _List_fromArray([
            ...
            A2(
              $author$project$Main$badge,
              $elm$core$String$fromInt(passed) + ' passed',
              '#16a34a',
            ),
            A2(
              $author$project$Main$badge,
              $elm$core$String$fromInt(failed) + ' failed',
              !failed ? '#9ca3af' : '#dc2626',
            ),
            A2(
              $elm$html$Html$span,
              _List_fromArray([
        ...
        A2(
          $elm$html$Html$div,
          _List_Nil,
          $author$project$Main$viewTestGroups(results),
        ),
      ]),
    );
  };
    ...
    return A2(
      ...
      _List_fromArray([
        A2(
          ...
          _List_fromArray([
            $elm$html$Html$text(
              'Elm XSS Protection — Port Middleware Demo',
            ),
          ]),
        ),
        A2(
          ...
          _List_fromArray([
            $elm$html$Html$text(
              'Proof-of-concept library demonstrating compile-time policy enforcement at the Elm → JavaScript port boundary.',
            ),
          ]),
        ),
        A2(
          ...
          _List_fromArray([
            A3(
              ...
              $author$project$Main$DemoTab,
              'Interactive Demo',
              model.activeTab,
            ),
            A3(
              $author$project$Main$tabButton,
              $author$project$Main$TestsTab,
              'Test Suite',
              model.activeTab,
            ),
            A3(
        ...
        (function () {
          ...
          switch (_v0.$) {
            ...
            case 'TestsTab':
              return $author$project$Main$viewTests(
                $author$project$Tests$runAllTests,
              );
            default:
              return $author$project$Main$viewComparison(
                model,
              );
          }
        })(),
